...
├── README.md
├── notes/
│   └── WSL-Windows-AWS-EC2-Bidirectional-File-Transfer-Study-Notes.md
├── labs/
├── scripts/
└── examples/
```

The folder name is short, descriptive, lowercase, and suitable for a Git repository or Linux practice directory.
